...
User Report in all parameter success [20000]	
	...
	${setValueKey}=    Set Variable    {"${getData}[6]":"${CHARGING_ASGARD_MQTT__VALUE_TST_F3_1_1_002_SENSOR}"}
	#set data use cross testcase
...
Report : Check Summary Log [CDR]
    ...
    ${body}=    Set Variable    {"${getData}[6]":"${CHARGING_ASGARD_MQTT__VALUE_TST_F3_1_1_002_SENSOR}"}
