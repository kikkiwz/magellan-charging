...
Remove Data
	...
	Not RemoveThingFromAccount Config Request RemoveData Staging    ${getData}[0]    ${getData}[1]    ${getData}[2]    ${getData}[3]    ${getData}[6]    ${getData}[7]    ${getData}[9]    
