...
Config : Get Device Detail all parameter success [40400]
	...
	#Url
	Input Url    ${ASGARD_COAPAP_IMAGE_TXT_URL_CONFIG}    ${url}?${ASGARD_COAPAPI_VALUE_TST_F2_1_0_008_SENSOR_INVALID}    ${ASGARD_COAPAP_IMAGE_TXT_URL_NULL}
...
Config : Check Detail log [EDR] and Summary Log [CDR]
	...
	${pathUrl}=    Set Variable    ${pathUrlReplace}?${ASGARD_COAPAPI_VALUE_TST_F2_1_0_008_SENSOR_INVALID}
