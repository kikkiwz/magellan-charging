...
Report : Check Detail log [EDR] and Summary Log [CDR]
	...
	${pathUrlReplace}=    Replace Parameters Path    ${ASGARD_COAPAPP_URL_REPORT}    ${ASGARD_COAPAPP_FIELD_TOKEN}    ${thingToken}    ${ASGARD_COAPAPP_FIELD_IPADDRESS}    ${ASGARD_COAPAPP_IP_ADDRESS}
	...
	${body}=    Set Variable    {"ThingToken":"${thingToken}","IpAddress":"${ASGARD_COAPAPP_IP_ADDRESS}","Payloads":{"${getData}[7]":"${setValueKey}"},"UnixTimestampMs":[tid]}
