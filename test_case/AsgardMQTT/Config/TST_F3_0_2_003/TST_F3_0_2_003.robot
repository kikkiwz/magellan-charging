...
User Config Per Sensor parameter fail [40300]	
	#Click Disconnect
	...
	Input Text    ${ASGARD_MQTT_IMAGE_TXT_PUBLISH_TOPIC_AFTERCLEAR}    ${urlPulishConfig}${ASGARD_MQTT_VALUE_TST_F3_0_2_003_URL_SENSORNAME_INVALID}
	#Click    ${ASGARD_MQTT_IMAGE_BTN_PUBLISH}
	...
	${urlSubscriptionConfig}=    Replace Parameters    ${urlSubscriptionConfigReplace}    ${ASGARD_MQTT_FIELD_SENSORNAME}    ${VALUE_CONFIGINFO_KEY_REFRESHTIME}
...
Config : Check Detail log [EDR] and Summary Log [CDR]
	...
	${pathUrl}=    Replace String    ${pathUrlReplace}${ASGARD_MQTT_VALUE_TST_F3_0_2_003_URL_SENSORNAME_INVALID}    /    .
